 ...
 * @author Vagabondan
 */
public class Sender42 implements ISenderProtocol {
	 ...
	 * discovery data
	 */
	private static final String ZBX_PROTO_VALUE_HISTORY_DATA="proxy data";
    ...
    private String openJson(String type, String proxyName) {
		...
		//	"clock":UNIXTIMESTAMP,
		//	"ns":NS}
		String str=new String("{\"request\":\""+type+"\",\"version\":\"4.2\""+",\"host\":\""+proxyName+"\",\"history data\":[");
		return str;
	}
	
	private String buildJsonData(ZabbixItem it,int id) {
		//{"request":(ZBX_PROTO_VALUE_HISTORY_DATA|ZBX_PROTO_VALUE_DISCOVERY_DATA|ZBX_PROTO_VALUE_AUTO_REGISTRATION_DATA),
		//	"host":DBforBix, 
		//	"data":[{"host":HOST_NAME,"key":KEY,"clock":CLOCK,"ns":NS},{},...],
		//	"clock":UNIXTIMESTAMP,
